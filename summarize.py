...
DECISION_RULE = (
    "Решение — это только явная договорённость или поручение: кто-то что-то сделает, "
    "что-то решили изменить, перенести, запустить. Констатации фактов, мнения и общие "
    "пожелания решениями не считаются."
)
